...
\subsection{Que fait-on?}% Des fichiers, des courriers, des fichiers en lien hypertexte. C'est ici que se place le web
...
\begin{frame}
	\begin{itemize}
		...
		\item Le plus fameux \texbf{le World Wide Web/la Toile} (1990).
	\end{itemize}
\end{frame}
...
\begin{frame}
	\begin{itemize}
		...
		\item Relier de l'information sur la base de liens \texbf{hypertextes}.
