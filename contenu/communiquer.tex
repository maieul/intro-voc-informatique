...
\begin{frame}
	\begin{itemize}
		...
		\item IP se base sur notion de \texbf{paquets}:
			...
			\end{itemize}
		\item \formeenglish{Internet Corporation for Assigned Names and Numbers} attribut les adresses IP:
			\begin{itemize}
...
\begin{frame}
	\begin{itemize}
		\item Pour éviter de retenir les address IP ont a inventé (1983) le \texbf{nom de domaines}.
