...
\newcommand\position[2]{
		\vskip 0pt plus 1filll\hfill
		\positiontab{#1}{#2}
		\vspace{\baselineskip}
}
\newcommand{\positiondansliste}[2]{
	\hfill\begin{minipage}{0.1\textwidth}
	\positiontab{#1}{#2}
	\end{minipage}
}
\newcommand\positiontab[2]{
  \begin{tikzpicture}[baseline=(a.north),scale=2] % Largeur = 1,4 fois hauteur (proportion de feuilles de papier, arrondi)
    \coordinate (a) at (0,0);
