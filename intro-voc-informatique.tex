...
\begin{slide}
	\begin{itemize}
		...
		\item Manipulées sous forme \texbf{binaire} pour des contraintes matérielless:
			\begin{itemize}
...
\begin{slide}
	\begin{itemize}
		\item La \texbf{machine} manipule des \textbf{nombres}.
...
\begin{slide}
	\begin{itemize}
		...
		\item Attribuer un nombre différent à chaque caractère : \texbf{jeu de caractères codés}.
		\item Définir comment on stocke ces caractères : \texbf{codages des caractères}
	\end{itemize}
\end{slide}
\begin{slide}
	\begin{itemize}
